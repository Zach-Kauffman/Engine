...
public:
	...
	static std::tuple<sf::Vector2f, sf::Vector2f, unsigned int> getKineticResponseDoublePolygon(sf::Vector2f vel, const polygon& polyA, const polygon& polyB, const bool& isHollow);
